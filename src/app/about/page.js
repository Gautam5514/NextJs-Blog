                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="md:w-1/3">
                                <img src="/images/devfest.jpg" alt="Harry as a beginner" className="w-full rounded-lg shadow-lg" />
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="md:w-1/3">
                                <img src="/images/devfest.jpg" alt="Harry working on a big project" className="w-full rounded-lg shadow-lg" />
                            </div>
                            <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                        ...
                        {/* <div className="flex flex-col md:flex-row-reverse items-center">
                            <div className="md:w-1/3">
                                <img src="/images/devfest.jpg" alt="Harry mentoring others" className="w-full rounded-lg shadow-lg" />
                            </div>
                            <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
